...
- PFEAL: A Novel Framework for Image Anomaly Detection Using Pre-Trained Feature Extraction and Activation Learning [[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11034765)]
- Progressive Boundary Guided Anomaly Synthesis for Industrial Anomaly Detection [[paper](https://ieeexplore.ieee.org/abstract/document/10716437)]  [[code](https://github.com/cqylunlun/PBAS)]
- Sensitivity Analysis-Based Explainable Diffusion Transformers for Anomaly Detection in Consumer Electronics Manufacturing [[paper](https://ieeexplore.ieee.org/abstract/document/10835408)]
